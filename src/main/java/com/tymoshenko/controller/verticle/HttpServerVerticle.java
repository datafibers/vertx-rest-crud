...
public class HttpServerVerticle extends AbstractVerticle {
    ...
    private final WhiskyCrudRestService _whiskyCrudRestService;

    public HttpServerVerticle(final ApplicationContext applicationContext) {
        this._whiskyCrudRestService = (WhiskyCrudRestService) applicationContext.getBean("whiskyCrudRestService");
    }
    ...
    private void launchHttpServer(Future<Void> fut) {
        Router httpRequestRouter = _whiskyCrudRestService.createHttpRequestRouter(vertx);
